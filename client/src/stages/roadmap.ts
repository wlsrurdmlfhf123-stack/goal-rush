...
export const STAGE_PLANS: StagePlan[] = [
  ...
  },
  {
    ...
    theme: "혼자서는 움직이지 않는 무게 + 공을 빼앗기는 상황 + 협동 골",
    coop: "문틀에 낀 상자를 둘이 붙어서 밀어야 길이 열린다. 골문은 좌우 발판을 동시에 밟아야 열리고, 골은 둘 다 공을 건드린 뒤라야 인정된다",
    needs: ["pushblock", "press", "jumppad", "coopgate", "conveyor", "ice", "bumper", "lever", "holdgate"],
    terrain: "레인을 막는 문틀(walls), 상자가 딱 맞게 끼는 4.4m 구멍",
    status: "playable",
  },
  {
  ...
  },
  {
    ...
    needs: ["shutter", "spinner", "roller"],   // 공 도둑은 기믹이 아니라 봇 역할이다 (bot.ts BotRole "thief")
  ...
  },
  {
    ...
    needs: ["holdgate", "lever", "platform", "wind", "conveyor", "press"],
