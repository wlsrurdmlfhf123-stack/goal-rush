...
function controlTargetOf(playerId, allIds) {
...
console.log("\n--- TEST 1: \uC11C\uB85C\uC870\uC885 \uB9E4\uD551 \uADDC\uCE59 ---");
{
  ...
  check(
    "3\uC778\uC77C \uB54C \uC544\uBB34\uB3C4 \uC790\uC2E0\uC744 \uC870\uC885 \uC548 \uD568",
    three.every((id) => controlTargetOf(id, three) !== id),
    JSON.stringify(map)
  );
}
function buildWorld() {
  ...
  const gm = new CANNON2.Material("ground");
  const bm = new CANNON2.Material("body");
...
console.log("\n--- TEST 2: P1\uC758 \uC785\uB825\uC774 \uC2E4\uC81C\uB85C P2\uC758 \uBAB8\uC744 \uC6C0\uC9C1\uC774\uB294\uAC00 ---");
{
  ...
  const ids = [1, 2];
  const rags = /* @__PURE__ */ new Map();
  ids.forEach((id, i) => {
    const g = groupFor(id);
    const mask = (GROUP_WORLD | 65534) & ~g;
    rags.set(id, createRagdoll(
      physics,
      scene,
      new CANNON2.Vec3(i * 4 - 2, P.rideHeight + 0.15, 0),
      bm,
  ...
  check("P1\uC774 \uC785\uB825\uD588\uB294\uB370 P2\uC758 \uBAB8\uC774 \uC6C0\uC9C1\uC784", p2Moved > 1, `p2\u0394z=${p2Moved.toFixed(2)}`);
  check("P1 \uC790\uC2E0\uC758 \uBAB8\uC740 \uAC70\uC758 \uC548 \uC6C0\uC9C1\uC784", Math.abs(p1Moved) < 1, `p1\u0394z=${p1Moved.toFixed(2)}`);
  check(
    "\uB450 \uCE90\uB9AD\uD130 \uBAA8\uB450 \uC720\uD55C\uAC12",
...
console.log("\n--- TEST 3: \uD63C\uC790 \uC788\uC744 \uB550 \uC790\uAE30 \uCE90\uB9AD\uD130\uAC00 \uC6C0\uC9C1\uC778\uB2E4 ---");
{
  ...
  check("\uD63C\uC790\uC77C \uB54C \uC790\uAE30 \uCE90\uB9AD\uD130\uAC00 \uC774\uB3D9\uD568", moved > 1, `\u0394z=${moved.toFixed(2)}`);
}
console.log(`
