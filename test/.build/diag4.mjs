...
function build(cfg) {
  ...
  physics.solver.iterations = cfg.iters ?? 22;
  ...
  const cm = (a, b, o) => {
    const m = new CANNON2.ContactMaterial(a, b, o);
...
function penetrationTest(label, cfg) {
  ...
  console.log(
    `  ${label.padEnd(34)} \uD1B5\uACFC=${passedThrough ? "\uC608 \u2717" : "\uC544\uB2C8\uC624 \u2713"}  \uCD5C\uC18C\uAC04\uACA9=${minGap.toFixed(2)}  \uCD5C\uACE0\uACE8\uBC18\uB192\uC774=${maxPelvisY.toFixed(2)}  \uB0C9\uC7A5\uACE0z=${fridge.position.z.toFixed(2)} y=${fridge.position.y.toFixed(2)}`
  );
}
